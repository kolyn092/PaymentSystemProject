...
public class WebhookController {
    ...
    @PostMapping("/webhook")
    public ResponseEntity<ApiResponse<Void>> receiveWebhook(@RequestBody String body,
        @RequestHeader("webhook-id") String webhookId, @RequestHeader("webhook-signature") String signature,
        ...
        try {
            ...
            return ResponseEntity.badRequest().body(ApiResponse.error(ErrorCode.WEBHOOK_VERIFICATION_FAILED));
        }
    }
}
